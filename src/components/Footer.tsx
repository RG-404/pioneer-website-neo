...
const Footer = () => {
  return (
    <footer className="bg-black pt-12 pb-6 text-neutral-500">
      <div className="w-[85%] mx-auto">
        <div className="grid grid-cols-3 md:grid-cols-6 lg:grid-cols-7  xl:gap-8 sm:gap-6 gap-5 lg:mb-36 mb-16">
          <div className='lg:col-span-4 lg:grid-cols-2 md:col-span-3 col-span-3'>
            <div className="flex items-center gap-2 mb-4">
              <span className="text-white text-xl font-semibold">Pioneer Regis</span>
            </div>
            <p className="font-medium text-sm leading-relaxed">
              Office Building Name<br />
              Road Name, Locality<br />
        ...
        <div className="text-neutral-500 text-center text-sm">
          <span>© {new Date().getFullYear()} Pioneer Regis. All rights reserved.</span>
        </div>
      </div>
    </footer>
  );
