...
//     <div className="py-8 sm:py-12 md:py-16 text-[#9C9C9C] text-base sm:text-lg">
//       <p>
...
// {/* STORY SECTION */}
// <div className="w-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 py-10 border-b-2 border-dashed border-gray-200">
...
//   <div className="w-full lg:w-1/2 lg:px-6 space-y-4">
